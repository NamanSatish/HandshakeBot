...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        for pos in target_poses:
            ...
            '''request.ik_request.pose_stamped.pose.position.x = 0.985
            request.ik_request.pose_stamped.pose.position.y = 0.207
            request.ik_request.pose_stamped.pose.position.z = 0.443    
